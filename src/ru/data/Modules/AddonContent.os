...
Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока = ТаблицаСостава.Добавить();
    НоваяСтрока.Метод       = "ПолучитьПеременную";
    НоваяСтрока.МетодПоиска = "ПОЛУЧИТЬПЕРЕМЕННУЮ";
    НоваяСтрока.Параметр    = "--proj";
    НоваяСтрока.Описание    = "Путь к файлу проекта";
    НоваяСтрока.Область     = "Управление переменными";
    НоваяСтрока.ОписаниеМетода   = "Получает значение существующей переменной";


    НоваяСтрока = ТаблицаСостава.Добавить();
    НоваяСтрока.Метод       = "ПолучитьПеременную";
    НоваяСтрока.МетодПоиска = "ПОЛУЧИТЬПЕРЕМЕННУЮ";
    НоваяСтрока.Параметр    = "--var";
    НоваяСтрока.Описание    = "Имя переменной";
    НоваяСтрока.Область     = "Управление переменными";


    НоваяСтрока = ТаблицаСостава.Добавить();
    НоваяСтрока.Метод       = "ОбъявитьПеременную";
    НоваяСтрока.МетодПоиска = "ОБЪЯВИТЬПЕРЕМЕННУЮ";
    НоваяСтрока.Параметр    = "--proj";
    НоваяСтрока.Описание    = "Путь к файлу проекта";
    НоваяСтрока.Область     = "Управление переменными";
    НоваяСтрока.ОписаниеМетода   = "Объявляет новую переменную для использования при обработке запросов";
    ...
    НоваяСтрока = ТаблицаСостава.Добавить();
    НоваяСтрока.Метод       = "УдалитьПеременную";
    НоваяСтрока.МетодПоиска = "УДАЛИТЬПЕРЕМЕННУЮ";
    НоваяСтрока.Параметр    = "--proj";
    НоваяСтрока.Описание    = "Путь к файлу проекта";
    НоваяСтрока.Область     = "Управление переменными";
    НоваяСтрока.ОписаниеМетода   = "Удаляет ранее объявленную переменную";
    ...
    НоваяСтрока = ТаблицаСостава.Добавить();
    НоваяСтрока.Метод       = "УстановитьЗначениеПеременной";
    НоваяСтрока.МетодПоиска = "УСТАНОВИТЬЗНАЧЕНИЕПЕРЕМЕННОЙ";
    НоваяСтрока.Параметр    = "--proj";
    НоваяСтрока.Описание    = "Путь к файлу проекта";
    НоваяСтрока.Область     = "Управление переменными";
    НоваяСтрока.ОписаниеМетода   = "Устанавливает значение существующей переменной";
    ...
    НоваяСтрока.Метод       = "УстановитьЗначениеПеременной";
    НоваяСтрока.МетодПоиска = "УСТАНОВИТЬЗНАЧЕНИЕПЕРЕМЕННОЙ";
    НоваяСтрока.Параметр    = "--val";
    НоваяСтрока.Описание    = "Значение переменной";
    НоваяСтрока.Область     = "Управление переменными";
