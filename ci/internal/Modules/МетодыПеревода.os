...
Процедура ПеревестиПроект(Знач ФайлыМодулей, Знач КаталогФайлов) Экспорт
	...
	ИменаМодулей.Вставить("RequestHandler", Истина);
	ИменаМодулей.Вставить("IntegrationProxy", Истина);
	ИменаМодулей.Вставить("Help", Истина);
	ИменаМодулей.Вставить("AddonContent", Истина);
