...
Процедура ВывестиОшибкуВЛог(Знач Результат) Экспорт

    ИнициализироватьШаблонОшибкиЛога();

    OPI_ПреобразованиеТипов.ПолучитьСтроку(Результат);

    Результат = СтрЗаменить(Результат, Символы.ПС, " ");

    Сообщить(СтрШаблон(ШаблонОшибкиЛога, Результат));
...
Процедура ИнициализироватьШаблонОшибкиЛога()

    Если Не ЗначениеЗаполнено(ШаблонОшибкиЛога) Тогда

        ШаблонОшибкиЛога = "info: Melezh.Internal
        |      %1";
    КонецЕсли;
