...
Процедура ОчиститьАргументыОбработчика() Экспорт
	...
	Опции.Вставить("proj"   , ПутьПроекта);
	Опции.Вставить("handler", КлючОбработчика);
	Опции.Вставить("cron"   , КлючОбработчика);
...
Процедура ДобавитьРегламентноеЗадание() Экспорт
	...
	_Результат = TestTools.ВыполнитьТестCLI("ДобавитьРегламентноеЗадание", Опции);
	
	Ожидаем.Что(_Результат["result"]).Равно(Истина);
	Ожидаем.Что(_Результат["id"]).Заполнено();

	IDЗадания = _Результат["id"];

	TestTools.ЗаписатьЛог(_Результат, "ДобавитьРегламентноеЗадание");
	
КонецПроцедуры

&Порядок(17)
&Тест
Процедура ПолучитьРегламентноеЗадание() Экспорт

	Опции = Новый Структура;
	Опции.Вставить("proj"   , ПутьПроекта);
	Опции.Вставить("task"   , IDЗадания);

	_Результат = TestTools.ВыполнитьТестCLI("ПолучитьРегламентноеЗадание", Опции);
	...
	TestTools.ЗаписатьЛог(_Результат, "ПолучитьРегламентноеЗадание");

КонецПроцедуры

&Порядок(18)
&Тест
Процедура ПолучитьСписокРегламентныхЗаданий() Экспорт

	Опции = Новый Структура;
	Опции.Вставить("proj", ПутьПроекта);

	_Результат = TestTools.ВыполнитьТестCLI("ПолучитьСписокРегламентныхЗаданий", Опции);

	Ожидаем.Что(_Результат["result"]).Равно(Истина);
	Ожидаем.Что(_Результат["data"].Количество()).Равно(1);

	TestTools.ЗаписатьЛог(_Результат, "ПолучитьСписокРегламентныхЗаданий");

КонецПроцедуры

&Порядок(19)
&Тест
Процедура ИзменитьРегламентноеЗадание() Экспорт
	...
	_Результат = TestTools.ВыполнитьТестCLI("ИзменитьРегламентноеЗадание", Опции);
	...
	Результат = TestTools.ВыполнитьТестCLI("ПолучитьРегламентноеЗадание", Опции);

	Ожидаем.Что(_Результат["result"]).Равно(Истина);
	Ожидаем.Что(_Результат["data"]["id"]).Равно(IDЗадания);
	Ожидаем.Что(_Результат["data"]["handler"]).Равно(КлючОбработчика);
	Ожидаем.Что(_Результат["data"]["cron"]).Равно("0 8 8 * * * *");

	TestTools.ЗаписатьЛог(_Результат, "ИзменитьРегламентноеЗадание");
...
Процедура ОтключитьРегламентноеЗадание() Экспорт
	...
	_Результат = TestTools.ВыполнитьТестCLI("ОтключитьРегламентноеЗадание", Опции);
	...
	Ожидаем.Что(_Результат["result"]).Равно(Истина);
	Ожидаем.Что(_Результат["data"]["id"]).Равно(IDЗадания);
	Ожидаем.Что(_Результат["data"]["active"]).Равно(0);

	TestTools.ЗаписатьЛог(_Результат, "ОтключитьРегламентноеЗадание");
...
Процедура ВключитьРегламентноеЗадание() Экспорт
	...
	_Результат = TestTools.ВыполнитьТестCLI("ВключитьРегламентноеЗадание", Опции);
	...
	Ожидаем.Что(_Результат["result"]).Равно(Истина);
	Ожидаем.Что(_Результат["data"]["id"]).Равно(IDЗадания);
	Ожидаем.Что(_Результат["data"]["active"]).Равно(1);

	TestTools.ЗаписатьЛог(_Результат, "ВключитьРегламентноеЗадание");
...
Процедура УдалитьРегламентноеЗадание() Экспорт
	...
	_Результат = TestTools.ВыполнитьТестCLI("УдалитьРегламентноеЗадание", Опции);

	Ожидаем.Что(_Результат["result"]).Равно(Истина);

	Результат = TestTools.ВыполнитьТестCLI("ПолучитьРегламентноеЗадание", Опции);

	Ожидаем.Что(_Результат["result"]).Равно(Ложь);
	Ожидаем.Что(_Результат["error"]).Равно("Задание не найдено!");
