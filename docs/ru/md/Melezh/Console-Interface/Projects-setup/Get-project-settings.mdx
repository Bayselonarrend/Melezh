    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            melezh  ПолучитьНастройкиПроекта \
              --proj "C:\Users\bayselonarrend\AppData\Local\Temp\pmgobrmf.yfd"
        ```
    </TabItem>
...
```json title="Результат"
{
 "data": [
  ...
  },
  {
   ...
   "name": "logs_path",
   "value": "C:/Users/bayselonarrend/AppData/Local/Temp/Melezh/a603ceee-553d-4635-affa-61353a6f50ba"
  },
  {
