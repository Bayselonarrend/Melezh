> [!WARNING]
> **На данный момент этот проект заморожен в связи с нехваткой времени на его поддержку и отсутствия понимания курса его развития** <br><br>
> Хорошая, на первый взгляд, идея вклинить пайплайны разработки Melezh в существующие пайплайны OpenIntegrations, сыграли с ним злую шутку. Melezh тормозит выход новых версий основной библиотеки и усложняет процесс ее поддержки. И все это в условиях, где ресурсов не всегда хватает даже на нее. На данный момент, я бы хотел целиком сконцентрироваться на OpenIntegrations как на более перспективном проекте и сократить размер прочей нагрузки, которая напрямую к нему не относится
>
> Возможно, однажды этот проект оживет вновь. Но сейчас будет лучше честно признать, что поддерживать его сковзь зубы как часть OpenIntegrations объективно нет ни смысла, ни желания
