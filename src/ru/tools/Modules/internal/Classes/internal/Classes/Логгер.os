...
Процедура ЗаписатьЛог(Контекст, ТелоЗапроса, Знач Результат) Экспорт
	...
	Попытка
		...
		ЗаписыватьТелоЗапроса       = ?(ЗначениеЗаполнено(ЗаписыватьТелоЗапроса), Булево(ЗаписыватьТелоЗапроса), Ложь);

		ЗаписыватьЗаголовкиЗапроса  = ХранилищеНастроек.ВернутьНастройку("logs_req_headers");
		ЗаписыватьЗаголовкиЗапроса  = ?(ЗначениеЗаполнено(ЗаписыватьЗаголовкиЗапроса), Булево(ЗаписыватьЗаголовкиЗапроса), Ложь);

		ЗаписыватьТелоОтвета        = ХранилищеНастроек.ВернутьНастройку("logs_res_body");
		ЗаписыватьТелоОтвета        = ?(ЗначениеЗаполнено(ЗаписыватьТелоОтвета), Булево(ЗаписыватьТелоОтвета), Ложь);
