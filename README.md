...
Серверная версия Открытого пакета интеграций, предоставляющая единый настраиваемый HTTP API для доступа к любым его библиотекам с возможностью установки значений параметров по умолчанию, веб-консолью и встроенным логированием входящих запросов
...
- Добавлять, изменять и удалять обработчики, меня состав параметров по умолчанию
